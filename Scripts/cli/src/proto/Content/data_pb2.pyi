...
class DataBusResponseContent(_message.Message):
    __slots__ = ("deviceId", "dataType", "nonce", "suspended", "raw")
    ...
    def __init__(self, deviceId: _Optional[int] = ..., dataType: _Optional[_Union[DataType, str]] = ..., nonce: _Optional[int] = ..., suspended: _Optional[int] = ..., raw: _Optional[_Union[RawDataTypeValue, _Mapping]] = ...) -> None: ...
